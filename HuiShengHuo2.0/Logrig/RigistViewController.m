...
- (void)CreateLog
{
//    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 23+RECTSTATUS.size.height+25+35, 200, 0)];
//    titlelabel.text = @"登录";
//    titlelabel.font = [UIFont systemFontOfSize:27];
//    [self.view addSubview:titlelabel];
//
//    UILabel *miaosulabel = [[UILabel alloc] initWithFrame:CGRectMake(30, titlelabel.frame.size.height+titlelabel.frame.origin.y+14, Main_width-60, 0)];
...
//    [self.view addSubview:miaosulabel];
    ...
    UIImageView *imageview1 = [[UIImageView alloc] initWithFrame:CGRectMake(30, RECTSTATUS.size.height+44+25, 24, 24)];
...
- (void)Log
{
    if (phonbe.text.length==0) {
        ...
        _dict = @{@"username":phonbe.text,@"mobile_vcode":yanzhengmatextfield.text,@"phone_name":[userdefaults objectForKey:@"registrationID"],@"phone_type":@"2",@"wx_userinfo":jsonStr};
