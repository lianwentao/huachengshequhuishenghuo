...
#define ImageButtonWidth [UIScreen mainScreen].bounds.size.width / 2
...
- (void)setupUI {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        self.imageButton.frame = CGRectMake(i * ImageButtonWidth, 0, ImageButtonWidth, ImageButtonWidth/2);
