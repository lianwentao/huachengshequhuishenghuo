...
NSString * const YZUpdateMenuTitleNote2 = @"YZUpdateMenuTitleNote2";
NSString * const YZUpdateMenuTitleNote3 = @"YZUpdateMenuTitleNote3";
NSString * const YZUpdateMenuTitleNote4 = @"YZUpdateMenuTitleNote4";
NSString * const YZUpdateMenuTitleNote5 = @"YZUpdateMenuTitleNote5";
...
@property (nonatomic, weak)   id observer3;
@property (nonatomic, weak)   id observer4;
@property (nonatomic, weak)   id observer5;
@end
...
- (void)setup
{
    ...
    _observer2 = [[NSNotificationCenter defaultCenter] addObserverForName:YZUpdateMenuTitleNote2 object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification * _Nonnull note) {
    ...
    // 监听更新菜单标题通知
    _observer3 = [[NSNotificationCenter defaultCenter] addObserverForName:YZUpdateMenuTitleNote3 object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification * _Nonnull note) {
    ...
    _observer4 = [[NSNotificationCenter defaultCenter] addObserverForName:YZUpdateMenuTitleNote4 object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification * _Nonnull note) {
    ...
    _observer5 = [[NSNotificationCenter defaultCenter] addObserverForName:YZUpdateMenuTitleNote5 object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification * _Nonnull note) {
