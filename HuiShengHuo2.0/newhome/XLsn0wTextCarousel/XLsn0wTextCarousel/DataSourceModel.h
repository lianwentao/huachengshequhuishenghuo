...
@property (nonatomic, strong) NSString *time;//滚动时间
 ...
 */
+ (instancetype)dataSourceModelWithType:(NSString *)type title:(NSString *)title time:(NSString *)time URLString:(NSString *)URLString;
