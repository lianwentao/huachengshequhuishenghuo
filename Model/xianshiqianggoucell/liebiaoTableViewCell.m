...
- (void)setModel:(liebiaomodel *)model
{
    ...
    _dic = @{@"p_id":model.id,@"tagid":model.tagid,@"p_title":model.title,@"price":model.nowprice,@"tagname":model.tagname,@"p_title_img":model.title_img,@"apk_token":uid_username,@"number":@"1",@"token":[user objectForKey:@"token"],@"tokenSecret":[user objectForKey:@"tokenSecret"]};//token tokenSecret
}
