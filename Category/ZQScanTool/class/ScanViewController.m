...
- (void)setOverlayPickerView
{
    ...
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(54, RECTSTATUS.size.height, Main_width-54*2, 44)];
    titlelabel.text = @"扫描二维码付款";
    titlelabel.font = [UIFont systemFontOfSize:20];
    titlelabel.textColor = [UIColor whiteColor];
    titlelabel.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:titlelabel];
    
    UIButton *cancleBtn = [[UIButton alloc] initWithFrame:CGRectMake(5, RECTSTATUS.size.height, 44, 44)];
    [cancleBtn setImage:[UIImage imageNamed:@"base_action_bar_back_bg_n"] forState:UIControlStateNormal];
