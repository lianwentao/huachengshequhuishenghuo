...
//    UIView *view = [[UIView alloc] initWithFrame:CGRectMake((kScreenWidth - 60) / 2.0-1.5, _viewHeight - 50+2.5, 1.5, 45)];
...
//        _cancelButton.tag = 1;
//        _cancelButton.backgroundColor = QIColor;
//
...
- (UIButton *)confirmButton {
    if (!_confirmButton) {
        ...
        _confirmButton.frame = (CGRect){0, _viewHeight - 50, (kScreenWidth - 60), 50};
