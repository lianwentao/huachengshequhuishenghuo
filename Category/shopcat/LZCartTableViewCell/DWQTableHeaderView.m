...
- (void)setupUI {
    ...
    [button setImage:[UIImage imageNamed:@"shop_icon_xuanze_dianjiqian"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"shop_icon_xuanze_dianjihou"] forState:UIControlStateSelected];
