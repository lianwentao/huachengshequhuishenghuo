...
@interface XPFPickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
/** view */
...
- (void)quit {
    [UIView animateWithDuration:0.5 animations:^{
        ...
        NSLog(@"%@",self.result);
        [[NSNotificationCenter defaultCenter]postNotificationName:@"XPFPickerView" object:self.result];
